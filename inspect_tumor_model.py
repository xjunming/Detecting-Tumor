...
# Dataset directory
DATASET_DIR = os.path.join(ROOT_DIR, "./Detecting Tumor/dataset/")
...
# print('loading data from ',os.path.join(DATASET_DIR, "val"))
...
# weights_path = "/path/to/mask_rcnn_tumor.h5"
weights_path = "./model/dataset20190417T1119/mask_rcnn_dataset_0040.h5"
